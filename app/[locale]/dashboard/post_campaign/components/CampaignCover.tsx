...
export default function CampaignCover({ onImageChange, resetTrigger }: CampaignCoverProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="3xl:grid-cols-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <Card className="relative cursor-pointer overflow-hidden rounded-3xl border-none p-0 shadow-[0px_7.51px_11.27px_0px_#0000000D]">
